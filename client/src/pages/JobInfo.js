        ...
        {job && (
          <div>
            ...
            <div className="flex justify-content-between">
              {job.postedBy===userid ?(<Button><Link to={`/editjob/${job._id}`}>Edit Now</Link></Button> ):  alreadyApplied ? (<Tag color='green'>Already Applied</Tag>)  : (<Button onClick={applyNow}>Apply Now</Button>)}
